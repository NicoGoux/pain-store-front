	...
	return (
		...
		>
			<div className='flex items-center justify-center gap-6'>
				<figure className='w-full max-w-[250px] min-h-[150px] max-h-[200px] aspect-square mt-2 mx-9'>
					<img
			...
			<div className='flex justify-between text-secondary-font-color font-normal text-sm px-6 pb-2 h-14'>
				<div>
