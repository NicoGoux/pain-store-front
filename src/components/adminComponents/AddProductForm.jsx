...
import { DatepickerInput } from '../auxComponents/datepicker/Datepicker';
import { CategorySelector } from '../auxComponents/comboBoxes/CategorySelector';
import { MarketHashSelector } from '../auxComponents/comboBoxes/MarketHashSelector';
...
function AddProductForm() {
	...
	return (
		<form
			...
			className='flex flex-col justify-center items-center gap-6 mb-20 xsm:pt-20 w-full h-fit overflow-y-auto scroll px-2'
		>
